...
/**
 * An abstract implementation for the different possible actions of {@link PersistenceControllerNew}
 * 
...
public abstract class AbstractAction {
  ...
  private PersistenceControllerNew persitenceController;
   ...
   * 
   */
  public AbstractAction(PersistenceControllerNew persitenceController) {
    this.persitenceController = persitenceController;
  }

  protected PersistenceControllerNew getPersistenceController() {
