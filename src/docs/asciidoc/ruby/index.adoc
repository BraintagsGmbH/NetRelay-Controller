...
=== `link:unavailable[ElFinderController]`
...
For the possible syntax and resolution, see `link:unavailable[ContextFieldValueResolver]`
...
== `link:unavailable[ContextFieldValueResolver]`
This implementation of `link:unavailable[IFieldValueResolver]` converts a variable name to its value.
...
== `link:unavailable[QueryTemplate]`
The query template, including the classes
- `link:unavailable[DynamicQuery]`
- `link:unavailable[NativeQuery]`
- `link:unavailable[Condition]`
- `link:unavailable[QueryPart]`
...
== `link:unavailable[QueryPoolController]`
...
On initialization, the JSON files are loaded and transformed into `link:unavailable[IQuery]` objects,
