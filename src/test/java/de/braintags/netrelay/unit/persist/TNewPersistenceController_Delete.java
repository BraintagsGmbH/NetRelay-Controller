 ...
 * 
 */
public class TNewPersistenceController_Delete extends AbstractPersistenceControllerTest {
  private static final io.vertx.core.logging.Logger LOGGER = io.vertx.core.logging.LoggerFactory
      .getLogger(TNewPersistenceController_Delete.class);
  ...
  public void testDeleteRecordAsParameter(TestContext context) {
    ...
    String id = mapper.id;
    try {
      String url = "/products/delete2.html?" + createReferenceAsParameter(context, Action.DELETE, mapper);
      testRequest(context, HttpMethod.POST, url, null, resp -> {
        LOGGER.info("RESPONSE: " + resp.content);
        context.assertTrue(resp.content.toString().contains("deleteSuccess"), "Expected name not found");
      }, 200, "OK", null);
