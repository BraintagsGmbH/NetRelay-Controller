 ...
 *
 */
public class JsTreeListenerTest extends AbstractCaptureParameterTest {
  private static final io.vertx.core.logging.Logger LOGGER = io.vertx.core.logging.LoggerFactory
      .getLogger(JsTreeListenerTest.class);
  ...
  private void addListener() {
    ...
    RouterDefinition def = netRelay.getSettings().getRouterDefinitions()
        .getNamedDefinition(JsTreeController.class.getSimpleName());
    JsTreeController contr = (JsTreeController) def.getControllerInstance();
