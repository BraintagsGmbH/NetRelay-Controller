...
node {
   ...
   git url: 'https://github.com/BraintagsGmbH/NetRelay-Controller.git'
...
//         sh "mvn -s settings.xml -Dsign.skip=true -DNetRelayPort=9898 -DstartMongoLocal=false -Dconnection_string=mongodb://192.168.42.180:27017 clean deploy"
         sh "mvn -s settings.xml -Dsign.skip=true -DNetRelayPort=9898 -DstartMongoLocal=true -DlocalPort=27030  -Dconnection_string=mongodb://localhost:27030 clean deploy"
